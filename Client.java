...
/*  @author Sangare Mamoutou comp 132, lab 8
* created on March 31, 2015
* Purpose: This program have two classes.
* Comp132Array class allows a client
*  to manipulate the array through the Clientlab8 class.
*  The client can use the public methods provides by
*  the comp132Array class (eg: setElement, getElement, findSmallest ...)
*  through the object array
*/
package Labs;
import java.awt.*;
...
public class ClientLab8 extends JFrame implements ActionListener {
   ...
   private Comp132Array array = new Comp132Array(); //created an array of type
                                                     // comp123Array
   public static void main(String[] args) {
      ClientLab8 frame = new  ClientLab8();
